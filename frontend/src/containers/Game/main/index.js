...
import { createCandleChart } from '../components/chart/TradingChart';
...
function MainGameScreen(props) {
  ...
  useEffect(()=>{
    ...
    if (!paymentInfo.betCoin) {
      ...
      setTradeToken(-1);
      const { candleStickChart } = createCandleChart();
      // const data = fetchData(cryptoParams);
      var data = [
  ...
  return (
    <div className={classes.container} >
      ...
      <div className={classes.tradingView} id='candle-chart'>
